    ...
    for path in os.listdir('/srv/trackdata/bydate/'):
        if os.path.isdir('/srv/trackdata/bydate/'+path) == True:
            ...
            if os.path.isfile('/srv/trackdata/bydate/'+xmlfile):
                ...
                topic,logtext,filepath,photosetname,phototitle,num_img_xml,createdate,trk_color,xmlimglist,xmltaglist,num_img_log=parsexml('/srv/trackdata/bydate/',xmlfile,False)
